...
//        }
//
//        if (!"admin".equalsIgnoreCase(user.get().getRole().toString())) {
...
//                if (existingUser.get().getRole().toString().equalsIgnoreCase(role)) {
...
//                existingUser.get().setRole(Role.valueOf(role));
